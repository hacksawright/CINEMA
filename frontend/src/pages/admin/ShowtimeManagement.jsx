      ...
      (async () => {
        try {
          ...
          if (showtime && showtime.id) {
            // update existing
            res = await fetch(`http://localhost:8000/api/showtimes/${showtime.id}`, {
              method: 'PUT',
            ...
            // create new
            res = await fetch('http://localhost:8000/api/showtimes', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify(payload)
            });
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            const res = await fetch(`http://localhost:8000/api/showtimes/${showtime.id}`, {
                              method: 'DELETE'
                            });
                            if (!res.ok) {
