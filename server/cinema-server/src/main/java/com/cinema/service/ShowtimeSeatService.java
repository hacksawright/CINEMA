...
public class ShowtimeSeatService {
    ...
    private final RoomService_duc roomService;
    ...
    public ShowtimeSeatInfoDTO getShowtimeSeatInfo(Long showtimeId) {
        ...
        List<String> bookedStatuses = List.of("BOOKED", "PAID", "PROCESSING", "SOLD");
        ...
        if (showtime.getStartsAt() != null) {
            dto.setShowDate(showtime.getStartsAt().toLocalDate());
            dto.setShowTime(showtime.getStartsAt().toLocalTime());
        }
